...
|ATHENA|An AWS cloud-based service which enables you to query data in the data lake using SQL (Presto SQL). .<br/><br/>https://aws.amazon.com/athena/?whats-new-cards.sort-by=item.additionalFields.postDateTime&whats-new-cards.sort-order=desc|
